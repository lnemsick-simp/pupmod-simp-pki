Puppet::Type.newtype(:pki_cert_sync) do
  ...
  newproperty(:source) do
    ...
    def insync?(is)
#FIXME  Any exceptions raised here will **not** be logged by the
#  Puppet code calling this method.  So, if we want any failures to
#  be logged in a meaningful fashion, we need to log the exception
